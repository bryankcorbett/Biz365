...
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative bg-orbai-templateframerwebsitewild-sand">
      ...
      {/* Login Form - Positioned inside the orb center */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-full max-w-sm pointer-events-auto">
          {/* Compact Login Card - Fits inside orb */}
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/20 border border-white/30 p-6">
            {/* Logo */}
            ...
            <div className={`text-center mb-4 transition-all duration-500 ease-out ${
              ...
              <h1 className="bg-[linear-gradient(0deg,rgba(0,0,0,1)_34%,rgba(255,255,255,1)_100%)] [-webkit-background-clip:text] bg-clip-text [-webkit-text-fill-color:transparent] [text-fill-color:transparent] [font-family:'Inter',Helvetica] font-medium text-xl tracking-[-0.3px] leading-tight mb-1">
                Welcome Back
              </h1>
              <p className="[font-family:'Inter',Helvetica] font-normal text-wwwsightfulcomblack text-sm opacity-70">
                Sign in to your dashboard
              </p>
            </div>

            {/* Social Login Buttons */}
            <div className={`flex gap-2 mb-4 transition-all duration-500 ease-out ${
              ...
              >
                ...
                <span className="[font-family:'Inter',Helvetica] font-medium text-wwwsightfulcomblack text-xs tracking-[0] leading-[18px]">
              ...
              >
                ...
                <span className="[font-family:'Inter',Helvetica] font-medium text-wwwsightfulcomwhite text-xs tracking-[0] leading-[18px]">
            ...
            {/* Separator */}
            <div className={`relative mb-4 transition-all duration-500 ease-out ${
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-3 text-xs uppercase tracking-wider text-gray-500 [font-family:'Inter',Helvetica] font-medium">
                  or use email
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className={`space-y-1 transition-all duration-500 ease-out ${
                ...
                <label className="[font-family:'Inter',Helvetica] font-medium text-wwwsightfulcomblack text-xs leading-none flex items-center gap-2">
                ...
                <input
                  type="email"
                  name="email"
                  className="w-full px-3 py-2 bg-white/80 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all duration-300 text-black placeholder-gray-500 hover:bg-white hover:border-gray-300 [font-family:'Inter',Helvetica] text-sm"
              ...
              <div className={`space-y-1 transition-all duration-500 ease-out ${
                ...
                <div className="relative">
                  <input
                    ...
                    name="password"
                    className="w-full px-3 py-2 bg-white/80 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all duration-300 text-black placeholder-gray-500 hover:bg-white hover:border-gray-300 pr-8 [font-family:'Inter',Helvetica] text-sm"
                    placeholder="••••••••"
                  ...
                  <button 
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors duration-200 p-1"
              ...
              <div className={`flex items-center justify-between text-xs transition-all duration-500 ease-out ${
                ...
                <label className="flex items-center gap-1">
                  <input 
                    type="checkbox" 
                    className="rounded border-gray-300 text-black focus:ring-black hover:border-gray-400 transition-all duration-200 w-3 h-3" 
                  />
                  <span className="text-gray-600 [font-family:'Inter',Helvetica] font-normal">Remember</span>
                </label>
                <Link
            ...
            <div className={`mt-4 text-center transition-all duration-500 ease-out ${
              ...
              <p className="[font-family:'Inter',Helvetica] font-normal text-wwwsightfulcomblack text-xs opacity-70">
