...
export const MainContentSection = () => {
  ...
  return (
    <section className="flex flex-col items-start pt-0 pb-[150px] px-0 w-full">
      <div className="flex gap-[60px] pt-40 pb-10 px-[60px] bg-orbai-templateframerwebsitewild-sand overflow-hidden flex-col items-center justify-center relative w-full">
        <div className="flex flex-col w-[2276px] h-[1031px] items-start absolute top-[-238px] -left-44">
        ...
        <div className="absolute w-[1923px] h-[746px] top-0 left-0 [background:radial-gradient(50%_50%_at_50%_50%,rgba(255,255,255,0)_0%,rgba(255,255,255,1)_100%)]" />

        <div className="flex flex-col max-w-[1200px] w-[1200px] items-center justify-center px-0 py-10 relative">
          <div className="flex flex-col max-w-[1028px] items-center justify-center gap-8 relative">
            ...
            <div className="flex flex-col items-center justify-center gap-4 relative w-full translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
              <div className="flex items-center justify-center gap-4 pl-[300.88px] pr-[300.89px] py-0 relative ml-[-1.89px] mr-[-1.89px]">
                <img
                  className="relative flex-[0_0_auto] z-[1]"
                  alt="Container"
                  src="https://c.animaapp.com/mewus0n76JsNvN/img/container.svg"
                />

                <div className="flex flex-col items-start relative z-0">
                  <div className="flex flex-col items-start relative w-full">
                    <h1 className="relative w-fit mt-[-1.00px] bg-[linear-gradient(11deg,rgba(0,0,0,1)_34%,rgba(255,255,255,1)_100%)] [-webkit-background-clip:text] bg-clip-text [-webkit-text-fill-color:transparent] [text-fill-color:transparent] [font-family:'Inter',Helvetica] font-normal text-transparent text-[100px] tracking-[-6.00px] leading-[120px] whitespace-nowrap">
                      ORB AI
                    </h1>
                  </div>
                </div>
              ...
              <div className="flex flex-col min-w-[446px] max-w-[446px] items-start relative">
        ...
        <footer className="flex gap-6 w-full bg-transparent flex-col items-center justify-center relative translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms]">
          ...
          <div className="flex items-center pt-6 pb-0 px-0 relative z-0">
            <div className="flex flex-col min-w-[1800px] items-start relative opacity-90">
